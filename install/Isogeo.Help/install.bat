...
IF /I "%~1"=="/int"       SET CFG_PATH=config.int.ps1& SHIFT & GOTO ARGS_PARSE
IF /I "%~1"=="/qa"       SET CFG_PATH=\\HQ.isogeo.fr\GlobalShare\Deployments\configs\QualityAssurance\Isogeo.Help\config.qa.ps1& SHIFT & GOTO ARGS_PARSE
IF /I "%~1"=="/prod"       SET CFG_PATH=\\HQ.isogeo.fr\GlobalShare\Deployments\configs\Production\Isogeo.Help\config.prod.ps1& SHIFT & GOTO ARGS_PARSE
